export default function Footer() {
  return (
    <footer className="grid grid-cols-2">
      {/* left side */}
      <aside className="font-inter flex flex-col items-end justify-center bg-[#1F2937] px-40 py-24 text-white">
        <div className="flex flex-col items-center justify-center">
          <h5 className="mb-6 text-[32px]">CONTACT US</h5>

          <ul className="flex flex-col items-center justify-center gap-1 text-xl">
      ...
      {/* right side */}
      <aside className="font-inter flex flex-col items-start justify-center bg-[#111827] px-40 py-24 text-white">
        <h5 className="mb-6 text-[32px]">Follow US</h5>
      ...
      {/* copy right */}
      <p className="font-inter col-span-2 bg-black py-4 text-center text-xl leading-[36px] font-medium text-white">
